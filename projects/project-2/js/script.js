...
let tabName = document.querySelector('.accordion-name__tab');
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  document.querySelectorAll('.accordion-name__tab').forEach(function (tabsBtn) {
...
let myPlaylistsSlider = new Swiper('.playlists__swiper', {
  keyboard: {
    // включить\выключить
    enabled: true,
    // включить\выключить
