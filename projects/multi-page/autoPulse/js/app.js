(() => {
    ...
    function initSliders() {
        bildSliders();
        if (document.querySelector(".bottom-services__slider")) {
            new swiper_core_Swiper(".bottom-services__slider", {
        ...
        if (document.querySelector(".testimonial__slider")) {
            new swiper_core_Swiper(".testimonial__slider", {
                modules: [ Pagination, Parallax, Autoplay ],
                observer: true,
                observeParents: true,
                parallax: true,
        ...
        if (document.querySelector(".posts__slider")) {
            new swiper_core_Swiper(".posts__slider", {
                modules: [ Pagination, Parallax, Autoplay ],
                observer: true,
                observeParents: true,
                parallax: true,
