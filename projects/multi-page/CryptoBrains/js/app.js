(() => {
    ...
    function initSliders() {
        bildSliders();
        if (document.querySelector(".advantages-home__slider")) new core(".advantages-home__slider", {
            ...
            speed: 800,
            pagination: {
                el: ".advantages-home__dotts",
                clickable: true
            },
            on: {}
        });
        if (document.querySelector(".comments-home__slider")) new core(".comments-home__slider", {
            modules: [ Navigation, Pagination ],
            observer: true,
            observeParents: true,
            spaceBetween: 30,
        ...
        if (document.querySelector(".hero-blog__slider")) new core(".hero-blog__slider", {
        ...
        if (document.querySelector(".similar-articles")) new core(".similar-articles__slider", {
    ...
    if (document.getElementById("userResume")) {
        const filesTitles = document.querySelectorAll(".details-application__subtitle"), filesConditions = document.querySelectorAll(".details-application__conditions");
        ...
        function uploadFile(file, preview, input, title, descr) {
            ...
            reader.onload = function(e) {
                ...
                if ([ "image/jpeg", "image/png" ].includes(file.type)) preview.innerHTML = `<img src="${e.target.result}" alt="Фото">`; else if ("application/pdf".includes(file.type)) preview.innerHTML = `<img src="img/form-jobs/pdf.png" alt="Pdf">`; else if ("application/msword".includes(file.type)) preview.innerHTML = `<img src="img/form-jobs/word.png" alt="Word">`;
            };
