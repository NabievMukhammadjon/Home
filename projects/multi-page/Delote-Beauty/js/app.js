...
***************************************************************************** */
        ...
        if (document.querySelector(".vacancy__form")) {
            ...
            var fileInput = document.querySelector(".file-vacancy__input"), script_button = document.querySelector(".file-vacancy__label"), the_return = document.querySelector(".file-return");
            script_button.addEventListener("keydown", (function(event) {
                if (13 == event.keyCode || 32 == event.keyCode) fileInput.focus();
            }));
            script_button.addEventListener("click", (function(event) {
                fileInput.focus();
                return false;
            }));
