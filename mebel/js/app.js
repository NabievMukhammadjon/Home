    ...
    (() => {
        ...
        function initSliders() {
            ...
            if (document.querySelector(".thumbs-ceilings")) {
                const thumbsSwiper = new swiper_core_Swiper(".thumbs-ceilings__slider", {
                ...
                new swiper_core_Swiper(".products-ceilings__slider", {
                    modules: [ Navigation, Pagination, Autoplay, Thumb ],
                    thumbs: {
                        swiper: thumbsSwiper
                    },
            ...
            if (document.querySelector(".bottom-comments")) new swiper_core_Swiper(".bottom-comments__slider", {
            ...
            if (document.querySelector(".first-gallery")) {
                const thumbsSwiper = new swiper_core_Swiper(".thumbs-gallery--1 .thumbs-gallery__slider", {
                    modules: [ Navigation, Pagination, Autoplay, Thumb ],
                    observer: true,
                    watchOverflow: true,
                    observeParents: true,
                ...
                new swiper_core_Swiper(".first-gallery", {
                    modules: [ Navigation, Pagination, Autoplay, Thumb ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: 1,
            ...
            if (document.querySelector(".second-gallery")) {
                const thumbsSwiper = new swiper_core_Swiper(".thumbs-gallery--2 .thumbs-gallery__slider", {
                    modules: [ Navigation, Pagination, Autoplay, Thumb ],
                    observer: true,
                    watchOverflow: true,
                    observeParents: true,
                ...
                new swiper_core_Swiper(".second-gallery", {
                    modules: [ Navigation, Pagination, Autoplay, Thumb ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: 1,
            ...
            if (document.querySelector(".price__slider-one")) new swiper_core_Swiper(".price__slider-one", {
                modules: [ Navigation, Pagination, Autoplay ],
                observer: true,
                observeParents: true,
                slidesPerView: 1.2,
            ...
            if (document.querySelector(".slider-works")) new swiper_core_Swiper(".slider-works", {
                modules: [ Navigation, Pagination, Autoplay ],
                observer: true,
                observeParents: true,
                slidesPerView: 1.2,
            ...
            if (document.querySelector(".thumbs-tabs")) {
                const thumbsSwiper = new swiper_core_Swiper(".twoLevel-thumbs", {
                    modules: [ Navigation, Pagination, Autoplay, Thumb ],
                    observer: true,
                    watchOverflow: true,
                    observeParents: true,
                ...
                new swiper_core_Swiper(".twoLevel-slide", {
                    modules: [ Navigation, Pagination, Autoplay, Thumb ],
                    thumbs: {
                        swiper: thumbsSwiper
                    },
            ...
            if (document.querySelector(".inexpensive-thumbs")) {
                const thumbsSwiper = new swiper_core_Swiper(".inexpensive-thumbs", {
                    modules: [ Navigation, Pagination, Autoplay, Thumb ],
                    observer: true,
                    watchOverflow: true,
                    observeParents: true,
                ...
                new swiper_core_Swiper(".inexpensive-slide", {
                    modules: [ Navigation, Pagination, Autoplay, Thumb ],
                    thumbs: {
                        swiper: thumbsSwiper
                    },
...
***************************************************************************** */
        ...
        document.querySelectorAll(".tabs-stages__title").forEach(((btn, i) => {
            ...
            btn.addEventListener("click", (e => {
                if (i === 0) tabsContent.classList.add("border-top"); else tabsContent.classList.remove("border-top");
            }));
        }));
        if (document.querySelector(".sales-page")) {
            const btnAll = document.querySelectorAll(".promotion-card__hide"), contentAll = document.querySelectorAll(".promotion-card__all");
        ...
        const tabsMobileCeilings = document.querySelector(".tabs-mobile-1"), tabsMobileCeilingsSpan = document.querySelector(".tabs-mobile-1 span"), tabsNavCeilings = document.querySelector(".ceilings-tabs__navs"), tabsTitleCeilings = document.querySelectorAll(".ceilings-tabs__title"), tabsBodyCeilings = document.querySelectorAll(".ceilings-tabs__body");
        ...
        const tabsMobilePrice = document.querySelector(".tabs-mobile-2"), tabsMobileSpanPrice = document.querySelector(".tabs-mobile-2 span"), tabsNavPrice = document.querySelector(".tabs-price__navs"), tabsTitlePrice = document.querySelectorAll(".tabs-price__title"), tabsBodyPrice = document.querySelectorAll(".tabs-price__body");
        if (tabsMobilePrice) {
        ...
        const tabsMobileCatalog = document.querySelector(".tabs-mobile-3"), tabsMobileSpanCatalog = document.querySelector(".tabs-mobile-3 span"), tabsNavCatalog = document.querySelector(".catalog-tabs__navs"), tabsTitleCatalog = document.querySelectorAll(".catalog-tabs__title"), tabsBodyCatalog = document.querySelectorAll(".catalog-tabs__body");
        ...
        const tabsMobileProduct = document.querySelector(".tabs-mobile-4"), tabsMobileSpanProduct = document.querySelector(".tabs-mobile-4 span"), tabsNavProduct = document.querySelector(".tabs-product__navs"), tabsTitleProduct = document.querySelectorAll(".tabs-product__title"), tabsBodyProduct = document.querySelectorAll(".tabs-product__body");
        ...
        const tabsMobileGallery = document.querySelector(".tabs-mobile-5"), tabsMobileSpanGallery = document.querySelector(".tabs-mobile-5 span"), tabsNavGallery = document.querySelector(".tabs-gallery__navs"), tabsTitleGallery = document.querySelectorAll(".tabs-gallery__title"), tabsBodyGallery = document.querySelectorAll(".tabs-gallery__body");
        ...
        function windowResize(tabNav) {
            if (window.innerWidth <= 991) {
                tabNav.hidden = true;
                if (calcBtn) calcBtn.textContent = "Рассчитать";
            } else {
                tabNav.hidden = false;
                if (calcBtn) calcBtn.textContent = "Получить точный расчет";
            }
        }
